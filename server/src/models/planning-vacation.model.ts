...
export const PlanningVacationModel = mongoose.model<PlanningVacationModelInterface, PlanningVacationModelInterfaceStatic>('planningvacation', PlanningVacationSchema);
